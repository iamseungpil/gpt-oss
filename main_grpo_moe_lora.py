...
def main_grpo_moe_lora():
    ...
    logger.info("🚀 Starting GPT-OSS ARC GRPO Training (MoE LoRA Fix)")
    logger.info("="*60)
    ...
    try:
        ...
        # 🎯 **BREAKTHROUGH FIX**: Add MoE Expert layers to LoRA targets!
        peft_config = LoraConfig(
            ...
            lora_alpha=32,
            lora_dropout=0.1,
            # 🔧 FIXED: Include MoE expert projection layers!
            target_modules=[
                # Attention layers
                "q_proj", "k_proj", "v_proj", "o_proj",
                # 🚀 MoE Expert layers (THE MISSING PIECE!)
        ...
        logger.info("✅ Model and tokenizer loaded successfully with MoE LoRA")
        ...
        logger.info("🚀 Starting GRPO training with MoE LoRA fix...")
        ...
        logger.info(f"💾 Model saved to {DATA_DIR / 'final_model_grpo_moe_lora'}")
